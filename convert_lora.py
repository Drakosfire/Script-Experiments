...
from diffusers.loaders import lora_conversion_utils as lora
input_lora = "/media/drakosfire/Shared/Docker/StatblockGenerator/models/stable-diffusion/token-generator-v1/white_1_0.safetensors"
unknown_state_dict = load_file(input_lora)
diffusers_state_dict = lora._convert_kohya_lora_to_diffusers(unknown_state_dict)
save_file(diffusers_state_dict, "./white_1_0_diff.safetensors")
