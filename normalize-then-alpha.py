...
def apply_transparency_to_white_areas(image_path):
    ...
    binary_image.save('03_binary_image.png')
    ...
    filled_image.save("filled_image_result.png")
    ...
    mask_image.save("fill_mask_result.png")
...
apply_transparency_to_white_areas('Bubbles the Floatgoat.png')
